...
export const metadata: Metadata = {
  title: 'Publicaciones Populares | PublishMind',
  description: 'Las publicaciones más populares y destacadas de PublishMind.',
};

export default async function PopularesPage() {
  const [publicacionesResponse, categoriasData, tags] = await Promise.all([
    getPublicaciones({ limit: 12 }), // TODO: Add proper sorting by popularity when available
    getCategorias(),
    getAllTags()
  ]);
        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <p className="max-w-3xl text-xl text-muted-foreground">
              Descubre el contenido más destacado y popular de nuestra plataforma.
            </p>
          </div>
